...
public class CopyTest {
  ...
  public void testAclToken() {
    AclToken token = RandomObjects.randomAclToken();
  ...
  public void testKeyValueCopy() {
    KeyValue kv = RandomObjects.randomKeyValue();
  ...
  public void testKeyValueListCopy() {
    ...
    list.add(RandomObjects.randomKeyValue());
    list.add(RandomObjects.randomKeyValue());
  ...
  public void testCoordinateListCopy() {
    ...
    list.add(RandomObjects.randomCoordinate());
    list.add(RandomObjects.randomCoordinate());
  ...
  public void testServiceCopy() {
    Service service = RandomObjects.randomService();
  ...
  public void testSessionCopy() {
    Session session = RandomObjects.randomSession();
  ...
  public void testSessionOptions() {
    SessionOptions opts = RandomObjects.randomSessionOptions();
  ...
  public void testCheckCopy() {
    Check check = RandomObjects.randomCheck();
  ...
  public void testNodeCopy() {
    Node node = RandomObjects.randomNode();
  ...
  public void testCoordinateCopy() {
    Coordinate coordinate = RandomObjects.randomCoordinate();
  ...
  public void testEventCopy() {
    Event event = RandomObjects.randomEvent();
  ...
  public void testPreparedQueryDefinitionCopy() {
    PreparedQueryDefinition pqd = RandomObjects.randomPreparedQueryDefinition();
  ...
  public void testServiceEntryCopy() {
    ServiceEntry entry = RandomObjects.randomServiceEntry();
  ...
  public void testServiceListCopy() {
    ...
    services.add(RandomObjects.randomService());
    services.add(RandomObjects.randomService());
  ...
  public void testSessionListCopy() {
    ...
    sessions.add(RandomObjects.randomSession());
    sessions.add(RandomObjects.randomSession());
  ...
  public void testNodeListCopy() {
    ...
    nodes.add(RandomObjects.randomNode());
    nodes.add(RandomObjects.randomNode());
  ...
  public void testEventListCopy() {
    ...
    events.add(RandomObjects.randomEvent());
    events.add(RandomObjects.randomEvent());
  ...
  public void testCheckListCopy() {
    ...
    checks.add(RandomObjects.randomCheck());
    checks.add(RandomObjects.randomCheck());
  ...
  public void testServiceEntryListCopy() {
    ...
    entries.add(RandomObjects.randomServiceEntry());
    entries.add(RandomObjects.randomServiceEntry());
