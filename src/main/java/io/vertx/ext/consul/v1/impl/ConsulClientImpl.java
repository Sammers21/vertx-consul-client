...
import io.vertx.ext.consul.v1.AclToken;
import io.vertx.ext.consul.v1.BlockingQueryOptions;
import io.vertx.ext.consul.v1.Check;
import io.vertx.ext.consul.v1.CheckList;
import io.vertx.ext.consul.v1.CheckOptions;
import io.vertx.ext.consul.v1.CheckQueryOptions;
import io.vertx.ext.consul.v1.CheckStatus;
import io.vertx.ext.consul.v1.ConsulClient;
import io.vertx.ext.consul.v1.ConsulClientOptions;
import io.vertx.ext.consul.v1.Coordinate;
import io.vertx.ext.consul.v1.CoordinateList;
import io.vertx.ext.consul.v1.DcCoordinates;
import io.vertx.ext.consul.v1.Event;
import io.vertx.ext.consul.v1.EventList;
import io.vertx.ext.consul.v1.EventListOptions;
import io.vertx.ext.consul.v1.EventOptions;
import io.vertx.ext.consul.v1.HealthState;
...
import io.vertx.ext.consul.v1.MaintenanceOptions;
import io.vertx.ext.consul.v1.Node;
import io.vertx.ext.consul.v1.NodeList;
import io.vertx.ext.consul.v1.NodeQueryOptions;
import io.vertx.ext.consul.v1.PreparedQueryDefinition;
import io.vertx.ext.consul.v1.PreparedQueryExecuteOptions;
import io.vertx.ext.consul.v1.PreparedQueryExecuteResponse;
import io.vertx.ext.consul.v1.Service;
import io.vertx.ext.consul.v1.ServiceEntry;
import io.vertx.ext.consul.v1.ServiceEntryList;
import io.vertx.ext.consul.v1.ServiceList;
import io.vertx.ext.consul.v1.ServiceOptions;
import io.vertx.ext.consul.v1.ServiceQueryOptions;
import io.vertx.ext.consul.v1.Session;
import io.vertx.ext.consul.v1.SessionList;
import io.vertx.ext.consul.v1.SessionOptions;
import io.vertx.ext.consul.v1.TxnRequest;
import io.vertx.ext.consul.v1.TxnResponse;
...
public class ConsulClientImpl implements ConsulClient {
  ...
  public ConsulClient getKeysWithOptions(String keyPrefix, BlockingQueryOptions options, Handler<AsyncResult<List<String>>> resultHandler) {
    ...
    request(KV_VALID_CODES, HttpMethod.GET, "/v1/kv/" + Utils.urlEncode(keyPrefix), query, null, resultHandler, resp -> {
  ...
  public ConsulClient getValueWithOptions(String key, BlockingQueryOptions options, Handler<AsyncResult<KeyValue>> resultHandler) {
    request(KV_VALID_CODES, HttpMethod.GET, "/v1/kv/" + Utils.urlEncode(key), new Query().put(options), null, resultHandler, resp -> {
      if (resp.statusCode() == HttpResponseStatus.NOT_FOUND.code()) {
        return new KeyValue();
      } else {
  ...
  public ConsulClient deleteValue(String key, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.DELETE, "/v1/kv/" + Utils.urlEncode(key), null, null, resultHandler);
    return this;
  }
  ...
  public ConsulClient deleteValues(String keyPrefix, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.DELETE, "/v1/kv/" + Utils.urlEncode(keyPrefix), Query.of("recurse", true), null, resultHandler);
    return this;
  }
  ...
  public ConsulClient putValueWithOptions(String key, String value, KeyValueOptions options, Handler<AsyncResult<Boolean>> resultHandler) {
    ...
    requestString(HttpMethod.PUT, "/v1/kv/" + Utils.urlEncode(key), query, value, resultHandler,
  ...
  public ConsulClient cloneAclToken(String id, Handler<AsyncResult<String>> idHandler) {
    requestObject(HttpMethod.PUT, "/v1/acl/clone/" + Utils.urlEncode(id), null, null, idHandler, (obj, headers) ->
      obj.getString("ID"));
    return this;
  }
  ...
  public ConsulClient infoAclToken(String id, Handler<AsyncResult<AclToken>> tokenHandler) {
    requestArray(HttpMethod.GET, "/v1/acl/info/" + Utils.urlEncode(id), null, null, tokenHandler, (arr, headers) -> {
  ...
  public ConsulClient destroyAclToken(String id, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/acl/destroy/" + Utils.urlEncode(id), null, null, resultHandler);
    return this;
  }
  ...
  public ConsulClient fireEventWithOptions(String name, EventOptions options, Handler<AsyncResult<Event>> resultHandler) {
    ...
    requestObject(HttpMethod.PUT, "/v1/event/fire/" + Utils.urlEncode(name), query, body, resultHandler, (jsonObject, headers) -> EventParser.parse(jsonObject));
    return this;
  }
  ...
  public ConsulClient maintenanceService(MaintenanceOptions opts, Handler<AsyncResult<Void>> resultHandler) {
    ...
    requestVoid(HttpMethod.PUT, "/v1/agent/service/maintenance/" + Utils.urlEncode(opts.getId()), query, null, resultHandler);
    return this;
  }

  @Override
  public ConsulClient deregisterService(String id, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/agent/service/deregister/" + Utils.urlEncode(id), null, null, resultHandler);
    return this;
  }
  ...
  public ConsulClient catalogServiceNodesWithOptions(String service, ServiceQueryOptions options, Handler<AsyncResult<ServiceList>> resultHandler) {
    ...
    requestArray(HttpMethod.GET, "/v1/catalog/service/" + Utils.urlEncode(service), query, null, resultHandler, (arr, headers) -> {
  ...
  public ConsulClient catalogDatacenters(Handler<AsyncResult<List<String>>> resultHandler) {
    requestArray(HttpMethod.GET, "/v1/catalog/datacenters", null, null, resultHandler, (arr, headers) -> Utils.listOf(arr));
    return this;
  }
  ...
  public ConsulClient healthChecksWithOptions(String service, CheckQueryOptions options, Handler<AsyncResult<CheckList>> resultHandler) {
    Query query = options == null ? null : Query.of("near", options.getNear()).put(options.getBlockingOptions());
    requestArray(HttpMethod.GET, "/v1/health/checks/" + Utils.urlEncode(service), query, null, resultHandler, (arr, headers) -> {
  ...
  public ConsulClient healthServiceNodesWithOptions(String service, boolean passing, ServiceQueryOptions options, Handler<AsyncResult<ServiceEntryList>> resultHandler) {
    ...
    requestArray(HttpMethod.GET, "/v1/health/service/" + Utils.urlEncode(service), query, null, resultHandler, (arr, headers) -> {
  ...
  public ConsulClient catalogNodeServicesWithOptions(String node, BlockingQueryOptions options, Handler<AsyncResult<ServiceList>> resultHandler) {
    requestObject(HttpMethod.GET, "/v1/catalog/node/" + Utils.urlEncode(node), Query.of(options), null, resultHandler, (json, headers) -> {
  ...
  public ConsulClient deregisterCheck(String checkId, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/agent/check/deregister/" + Utils.urlEncode(checkId), null, null, resultHandler);
    return this;
  }
  ...
  public ConsulClient passCheckWithNote(String checkId, String note, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/agent/check/pass/" + Utils.urlEncode(checkId), Query.of("note", note), null, resultHandler);
    return this;
  }
  ...
  public ConsulClient warnCheckWithNote(String checkId, String note, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/agent/check/warn/" + Utils.urlEncode(checkId), Query.of("note", note), null, resultHandler);
    return this;
  }
  ...
  public ConsulClient failCheckWithNote(String checkId, String note, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/agent/check/fail/" + Utils.urlEncode(checkId), Query.of("note", note), null, resultHandler);
    return this;
  }
  ...
  public ConsulClient updateCheckWithNote(String checkId, CheckStatus status, String note, Handler<AsyncResult<Void>> resultHandler) {
    ...
    requestVoid(HttpMethod.PUT, "/v1/agent/check/update/" + Utils.urlEncode(checkId), null, put.encode(), resultHandler);
    return this;
  }
  ...
  public ConsulClient infoSessionWithOptions(String id, BlockingQueryOptions options, Handler<AsyncResult<Session>> resultHandler) {
    requestArray(HttpMethod.GET, "/v1/session/info/" + Utils.urlEncode(id), Query.of(options), null, resultHandler, (sessions, headers) -> {
      if (sessions.size() == 0) {
  ...
  public ConsulClient renewSession(String id, Handler<AsyncResult<Session>> resultHandler) {
    requestArray(HttpMethod.PUT, "/v1/session/renew/" + Utils.urlEncode(id), null, null, resultHandler, (arr, headers) ->
  ...
  public ConsulClient listNodeSessionsWithOptions(String nodeId, BlockingQueryOptions options, Handler<AsyncResult<SessionList>> resultHandler) {
    requestArray(HttpMethod.GET, "/v1/session/node/" + Utils.urlEncode(nodeId), Query.of(options), null, resultHandler, (arr, headers) -> {
      List<Session> list = arr.stream().map(obj -> SessionParser.parse((JsonObject) obj)).collect(Collectors.toList());
      return new SessionList().setList(list).setIndex(Long.parseLong(headers.get(INDEX_HEADER)));
    });
    return this;
  ...
  public ConsulClient destroySession(String id, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.PUT, "/v1/session/destroy/" + Utils.urlEncode(id), null, null, resultHandler);
    return this;
  }
  ...
  private void getPreparedQueryList(String id, Handler<AsyncResult<List<PreparedQueryDefinition>>> resultHandler) {
    String path = "/v1/query" + (id == null ? "" : "/" + Utils.urlEncode(id));
  ...
  public ConsulClient deletePreparedQuery(String id, Handler<AsyncResult<Void>> resultHandler) {
    requestVoid(HttpMethod.DELETE, "/v1/query/" + Utils.urlEncode(id), null, null, resultHandler);
    return this;
  }
