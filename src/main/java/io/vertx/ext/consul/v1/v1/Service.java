...
import io.vertx.ext.consul.v1.v1.impl.Utils;
...
public class Service {
  ...
  public Service(JsonObject service) {
    ...
    this.tags = Utils.listOf(service.getJsonArray(SERVICE_TAGS));
    this.address = service.getString(SERVICE_ADDRESS);
    this.meta = Utils.mapStringString(service.getJsonObject(SERVICE_META));
